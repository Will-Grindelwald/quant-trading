...
@JsonSubTypes({
    @JsonSubTypes.Type(value = MarketEvent.class, name = "MARKET"),
...
public abstract class Event {
    ...
    public String toString() {
        return String.format("%s[id=%s, type=%s, timestamp=%s, symbol=%s]",
                getClass().getSimpleName(), eventId, type, timestamp, symbol);
    }
}
